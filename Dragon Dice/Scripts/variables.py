...
P2_COORDS = {
    ...
    "Home Army": (RIGHT_BOX_RIGHT_EDGE - INVERT_MODIFIER, P2_TOP_ROW_TOP, RIGHT_BOX_LEFT_EDGE - INVERT_MODIFIER, P2_TOP_ROW_BOTTOM),
    "Campaign Army": (MIDDLE_BOX_RIGHT_EDGE - INVERT_MODIFIER, P2_TOP_ROW_TOP, MIDDLE_BOX_LEFT_EDGE - INVERT_MODIFIER, P2_TOP_ROW_BOTTOM),
    "Horde Army": (LEFT_BOX_RIGHT_EDGE - INVERT_MODIFIER, P2_TOP_ROW_TOP, LEFT_BOX_LEFT_EDGE - INVERT_MODIFIER, P2_TOP_ROW_BOTTOM),
    "Summoning Pool": (MIDDLE_BOX_RIGHT_EDGE - INVERT_MODIFIER, P2_BOTTOM_ROW_TOP, MIDDLE_BOX_LEFT_EDGE - INVERT_MODIFIER, P2_BOTTOM_ROW_BOTTOM),
    "Reserves": (LEFT_BOX_RIGHT_EDGE - INVERT_MODIFIER, P2_BOTTOM_ROW_TOP, LEFT_BOX_LEFT_EDGE - INVERT_MODIFIER, P2_BOTTOM_ROW_BOTTOM),
    "DUA": (RIGHT_BOX_RIGHT_EDGE - INVERT_MODIFIER, P2_BOTTOM_ROW_TOP, RIGHT_BOX_LEFT_EDGE - INVERT_MODIFIER, P2_DUA_BOTTOM),
    "BUA": (RIGHT_BOX_RIGHT_EDGE - INVERT_MODIFIER, P2_BUA_TOP, RIGHT_BOX_LEFT_EDGE - INVERT_MODIFIER, P2_BOTTOM_ROW_BOTTOM)
}
