...
LEFT_BOX_LEFT_EDGE = -740
LEFT_BOX_RIGHT_EDGE = -285
MIDDLE_BOX_LEFT_EDGE = -245
MIDDLE_BOX_RIGHT_EDGE = 240
RIGHT_BOX_LEFT_EDGE = 270
RIGHT_BOX_RIGHT_EDGE = 725

P1_TOP_ROW_TOP = 35
P1_TOP_ROW_BOTTOM = 280
P1_BOTTOM_ROW_TOP = 305
P1_BOTTOM_ROW_BOTTOM = 550
P1_DUA_BOTTOM = 425
P1_BUA_TOP = 455

P2_TOP_ROW_TOP = -70
P2_TOP_ROW_BOTTOM = -315
P2_BOTTOM_ROW_TOP = -385
P2_BOTTOM_ROW_BOTTOM = -575
P2_DUA_BOTTOM = -450
P2_BUA_TOP = -500

DICE_VERTICAL_SHIFT = 40
DICE_VERTICAL_SHIFT_INVERTED = -60
DICE_HORIZ_SHIFT_INVERTED = 70

P1_COORDS = {
    "Home Terrain": (-540, -35, -540, -35),
    "Frontier Terrain": (-125, -35, -125, -35),
    "Home Army": (LEFT_BOX_LEFT_EDGE, P1_TOP_ROW_TOP, LEFT_BOX_RIGHT_EDGE, P1_TOP_ROW_BOTTOM),
    "Campaign Army": (MIDDLE_BOX_LEFT_EDGE, P1_TOP_ROW_TOP, MIDDLE_BOX_RIGHT_EDGE, P1_TOP_ROW_BOTTOM),
    "Horde Army": (RIGHT_BOX_LEFT_EDGE, P1_TOP_ROW_TOP, RIGHT_BOX_RIGHT_EDGE, P1_TOP_ROW_BOTTOM),
    "Summoning Pool": (MIDDLE_BOX_LEFT_EDGE, P1_BOTTOM_ROW_TOP, MIDDLE_BOX_RIGHT_EDGE, P1_BOTTOM_ROW_BOTTOM),
    "Reserves": (RIGHT_BOX_LEFT_EDGE, P1_BOTTOM_ROW_TOP, RIGHT_BOX_RIGHT_EDGE, P1_BOTTOM_ROW_BOTTOM),
    "DUA": (LEFT_BOX_LEFT_EDGE, P1_BOTTOM_ROW_TOP, LEFT_BOX_RIGHT_EDGE, P1_DUA_BOTTOM),
    "BUA": (LEFT_BOX_LEFT_EDGE, P1_BUA_TOP, LEFT_BOX_RIGHT_EDGE, P1_BOTTOM_ROW_BOTTOM)
}

P2_COORDS = {
    "Home Terrain": (470, -40, 470, -40),
    "Frontier Terrain": (55, -40, 55, -40),
    "Home Army": (RIGHT_BOX_RIGHT_EDGE - DICE_HORIZ_SHIFT_INVERTED, P2_TOP_ROW_TOP, RIGHT_BOX_LEFT_EDGE - DICE_HORIZ_SHIFT_INVERTED, P2_TOP_ROW_BOTTOM),
    "Campaign Army": (MIDDLE_BOX_RIGHT_EDGE - DICE_HORIZ_SHIFT_INVERTED, P2_TOP_ROW_TOP, MIDDLE_BOX_LEFT_EDGE - DICE_HORIZ_SHIFT_INVERTED, P2_TOP_ROW_BOTTOM),
    "Horde Army": (LEFT_BOX_RIGHT_EDGE - DICE_HORIZ_SHIFT_INVERTED, P2_TOP_ROW_TOP, LEFT_BOX_LEFT_EDGE - DICE_HORIZ_SHIFT_INVERTED, P2_TOP_ROW_BOTTOM),
    "Summoning Pool": (MIDDLE_BOX_RIGHT_EDGE - DICE_HORIZ_SHIFT_INVERTED, P2_BOTTOM_ROW_TOP, MIDDLE_BOX_LEFT_EDGE - DICE_HORIZ_SHIFT_INVERTED, P2_BOTTOM_ROW_BOTTOM),
    "Reserves": (LEFT_BOX_RIGHT_EDGE - DICE_HORIZ_SHIFT_INVERTED, P2_BOTTOM_ROW_TOP, LEFT_BOX_LEFT_EDGE - DICE_HORIZ_SHIFT_INVERTED, P2_BOTTOM_ROW_BOTTOM),
    "DUA": (RIGHT_BOX_RIGHT_EDGE - DICE_HORIZ_SHIFT_INVERTED, P2_BOTTOM_ROW_TOP, RIGHT_BOX_LEFT_EDGE - DICE_HORIZ_SHIFT_INVERTED, P2_DUA_BOTTOM),
    "BUA": (RIGHT_BOX_RIGHT_EDGE - DICE_HORIZ_SHIFT_INVERTED, P2_BUA_TOP, RIGHT_BOX_LEFT_EDGE - DICE_HORIZ_SHIFT_INVERTED, P2_BOTTOM_ROW_BOTTOM)
}
